...
const admin_address = '0x00b8192BAA2Ac87DEE21fD07F82FC4628550F953'
const admin_privateKey = '0xf23bff1b4823044a6eff1eb9ac0aa1c144d18cc9c7334e7776d2b0de873d5ac2'
...
const newAdmin = '0x00aea2F64262d114D7cFaF65adC81856D2be6Be6'; 
...
setNewAdmin(web3, admin_address, admin_privateKey, address, abi, newAdmin,  function(error , result) {
    if (error) {
        console.log(error);
      } else {
...
withdraw_ether(web3,  calleraddress, privateKey, address, abi, function(error , result) {
    if (error) {
        console.log(error);
      } else {
